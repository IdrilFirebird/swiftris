...
class Shape: Printable, Hashable {
    ...
    // The column and row representing the shape's anchor position
    var column, row:Int
...
// #3 1
            ...
            // Tubples (whatever that is don't work... 
            // http://stackoverflow.com/questions/28866426/swift-1-2-cannot-express-tuple-conversion-error
            // expressed in for loop it works ...
